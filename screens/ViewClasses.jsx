...
const ViewClasses = ({ navigation }) => {
    const { userId, fetchClasses, fetchAllClasses, fetchUserData } = useAppContext();
    ...
    useEffect(() => {
        const showCoachClasses = async () => {
            const myClasses = await fetchClasses(userId);
            setClasses(myClasses);
        };
        
        const showAllClasses = async () => {
            const myClasses = await fetchAllClasses(userId);
            setClasses(myClasses);
        };

  ...
  const handlePing = async () => {
    ...
    try {
      const response = await Promise.race([
        fetch("http://192.168.1.6:5000/api/detect2", {
          method: "POST",
        }),
        timeout,
      ]);
      ...
      if (response.ok) {
        ...
        Alert.alert("Chords", chords.chords);
      } else {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Image
            source={isDarkMode ? IconDark : IconLight}
            style={styles.logoImg}
          />
          <Text style={[styles.logoTxt, { color: currentTheme.textColor }]}>
            G! Tara Na!
          </Text>
        </View>
      ...
      <View style={styles.mainContent}>
        <View style={styles.quoteCont}>
          <Text style={[styles.mainTxt, { color: currentTheme.textColor }]}>
            Harmony Unleashed
          </Text>
          <Text style={[styles.subTxt, { color: currentTheme.textColor }]}>
            Your Ultimate Guide to Guitar Chords!
          </Text>
        </View>
        <Image
      ...
      <View style={styles.charBoxes}>
        ...
        >
          <FontAwesome5
            ...
            size={25}
          />
          <Text style={[styles.charTxt1, { color: currentTheme.textColor }]}>
            Easy To Use
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <FontAwesome6
            ...
            size={25}
          />
          <Text style={[styles.charTxt2, { color: currentTheme.textColor }]}>
            Ear Trainer
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Ionicons
            ...
            size={25}
          />
          <Text style={[styles.charTxt3, { color: currentTheme.textColor }]}>
            Harmonic Bliss
          </Text>
        </TouchableOpacity>
      </View>
